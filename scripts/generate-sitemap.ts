...
const staticEntries: SitemapEntry[] = [
  ...
  { path: "/concepts", changefreq: "weekly", priority: "0.9" },
  { path: "/concepts/data-access", changefreq: "monthly", priority: "0.8" },
  { path: "/concepts/lineage", changefreq: "monthly", priority: "0.8" },
